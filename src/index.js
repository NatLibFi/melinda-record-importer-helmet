...
async function run() {
  ...
  const transformedBlobHandler = transformedBlobHandlerFactory(riApiClient, melindaApiClient, amqplib, config);

  await startApp(config, riApiClient, melindaApiClient, transformedBlobHandler);
